 ...
 * @since Dec 21, 2008
 */
public class ChromaticNumber<V,E>
{
     ...
     * algorithm
     */
    public int findGreedyChromaticNumber(UndirectedGraph<V, E> g)
    {
     ...
     */
    public  Map<Integer, Set<V>> findGreedyColoredGroups(
        ...
        for (color = 0; sg.vertexSet().size() > 0; color++) {
                ...
                iter.hasNext();)
            {
                    ...
                    innerIter.hasNext();)
                {
                    ...
                    Set<V> vertexBeignEvaluated = new HashSet<>();
                    vertexBeignEvaluated.add(v);
                    vertexBeignEvaluated.add(temp);
                    Set<V> vertexAlreadyInThisCurrentColor = new HashSet<>();
                    vertexAlreadyInThisCurrentColor.addAll(currentColor);
                    newColorTuple.vertexColors.add(vertexBeignEvaluated);
                    newColorTuple.vertexColors.add(vertexAlreadyInThisCurrentColor);
                    newColorTuple.vertexColors.addAll(coloredGroups.values());
